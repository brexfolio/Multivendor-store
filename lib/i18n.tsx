...
const en = {
  ...
  admin: {
    ...
    settingsForm: {
      ...
      telegramChannel: "Telegram Channel ID / Username",
      channelPlaceholder: "@my_electronics_store",
      telegramGroup: "Telegram Group Chat ID",
      groupPlaceholder: "-1001234567890",
      groupTitle: "Connected Group Name",
      telegramGroupThread: "Topic / Thread ID (Optional)",
      threadPlaceholder: "e.g. 2 or leave blank",
      publishTarget: "Default Product Publishing Destination",
      targetChannel: "Channel Only",
      targetGroup: "Group Only",
      targetBoth: "Both Channel & Group",
      testGroupConnection: "Test Group Connection",
      testingGroup: "Testing Connection...",
      groupTestSuccess: "Successfully connected to group: {title}",
      groupTestError: "Unable to connect to group.",
...
const am: typeof en = {
  ...
  filters: {
    ...
    sortNewest: "አዳዲስ መጀመሪያ",
    availability: "የዕቃ ሁኔታ",
    inStockOnly: "ያሉ ብቻ (ክምችት ያለው)",
    priceRange: "የዋጋ ክልል (ብር)",
    minPrice: "ዝቅተኛ ዋጋ",
    maxPrice: "ከፍተኛ ዋጋ",
    quickRanges: "ፈጣን ክልሎች",
    under20k: "ከ20 ሺህ በታች",
    range20k50k: "20 ሺህ - 50 ሺህ",
    range50k100k: "50 ሺህ - 100 ሺህ",
    over100k: "100 ሺህ+",
    apply: "አጣራ",
    reset: "ሁሉንም አጽዳ",
  ...
  admin: {
    ...
    updateStatusLabel: "ሁኔታን አዘምን",
    updateStatusTitle: "ሁኔታን አዘምን",
    ...
    settingsForm: {
      ...
      telegramChannel: "የቴሌግራም ቻናል ID / ተጠቃሚ ስም",
      channelPlaceholder: "@my_electronics_store",
      telegramGroup: "የቴሌግራም ግሩፕ Chat ID",
      groupPlaceholder: "-1001234567890",
      groupTitle: "የተገናኘው ግሩፕ ስም",
      telegramGroupThread: "Topic / Thread ID (አማራጭ)",
      threadPlaceholder: "ለምሳሌ 2 ወይም ክፍት ይተውት",
      publishTarget: "ነባሪ የምርት ማተሚያ ቦታ",
      targetChannel: "ቻናል ብቻ",
      targetGroup: "ግሩፕ ብቻ",
      targetBoth: "ሁለቱም ቻናል እና ግሩፕ",
      testGroupConnection: "የግሩፕ ግንኙነትን ፈትሽ",
      testingGroup: "ግንኙነት በመፈተሽ ላይ...",
      groupTestSuccess: "ከግሩፕ ጋር በተሳካ ሁኔታ ተገናኝቷል፡ {title}",
      groupTestError: "ከግሩፕ ጋር መገናኘት አልተቻለም።",
